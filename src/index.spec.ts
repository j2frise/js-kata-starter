...
describe("Testing fractionCalc", () => {
  it("That's a test 1!", function () {
    ...
    const result: string = fractionCalc(fraction1Test, fraction2Test);
    const correct: string = "5/6"
  ...
  it("That's a test 5!", function () {
    ...
    const result: string = fractionCalc(fraction1Test, fraction2Test);
    const correct: string = "incorrect operation, division by 0"
    expect(result).toEqual(correct);
  });
});
